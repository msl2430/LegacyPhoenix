...
#End Region
    ...
    Public Sub BlankOutMedicaidFields()
        ...
        If (FAMISCaseInformation.AL.GetData().Substring(0, 1) = "0" Or FAMISCaseInformation.P05 = "C" Or FAMISCaseInformation.P05 = "D") Then
...
#Region "GUMP Functions"
    ...
    Private Sub setBlockData_Regular()
        ...
        getBlockData(FAMISFoodStampInformation.ZA)
        getBlockData(FAMISFoodStampInformation.ZF)
